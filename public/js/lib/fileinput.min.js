    ...
    _.prototype = {
        ...
        listen: function() {
            ...
            t.on("change", e.proxy(i.change, i)), e(window).on("resize", function() {
                ...
                var a, n = e(this),
                    r = !n.hasClass("disabled") && R(n.attr("disabled"));
        ...
        clearPreview: function() {
            ...
            i.remove(), e.$preview.find(".file-preview-frame").length || e.resetErrors()
        },
        ...
        uploadSingle: function(i, a, n) {
            var r, l, s, d, c, p, u, f, v, h = this,
                m = h.getFileStack().length,
                g = new FormData,
                w = h.previewInitId + "-" + i,
                b = e("#" + w + ":not(.file-preview-initial)"),
                x = b.find(".kv-file-upload"),
                C = b.find(".kv-file-remove"),
        ...
        previewDefault: function(i, t, a) {
            if (this.showPreview) {
                var n = this,
                    ...
                    l = (e("#" + t), n.previewSettings.other || L.other),
                    o = n.renderFileFooter(i.name, l.width),
                    s = n.getPreviewTemplate("other"),
        ...
        previewFile: function(e, i, t, a, n) {
            if (this.showPreview) {
                var r, l, o, s, d = this,
                    c = d.parseFileType(i),
                    p = d.slug(i.name),
                    u = d.allowedPreviewTypes,
                    f = d.allowedPreviewMimeTypes,
                    v = d.getPreviewTemplate(c),
                    h = M(c, d.previewSettings) ? d.previewSettings[c] : L[c],
                    m = parseInt(d.wrapTextLength, 10),
                    g = d.wrapIndicator,
                    w = u.indexOf(c) >= 0,
                    b = R(f) || !R(f) && -1 !== f.indexOf(i.type),
                    x = d.renderFileFooter(p, h.width),
                    C = "",
                    y = a.slice(a.lastIndexOf("-") + 1);
        ...
        readFiles: function(i) {
            function t(e) {
                ...
                if (!R(P) && z(P)) {
                    ...
                    if (0 === D) return b = a.msgInvalidFileType.repl("{name}", k).repl("{types}", S), void(a.isError = h(b, E, T, e))
                }
                return 0 !== D || R(U) || !z(U) || R($) || (C = k.match($), D += R(C) ? 0 : C.length, 0 !== D) ? a.showPreview ? (r.length > 0 && void 0 !== FileReader ? (s.html(d.repl("{index}", e + 1).repl("{files}", u)), o.addClass("loading"), l.onerror = function(e) {
                    a.errorHandler(e, k)
                }, l.onload = function(i) {
        ...
        checkDimensions: function(e, i, t, a, n, r, l) {
            var o, s, d, c = this,
                ...
                u = c[p + "Image" + r],
                f = t[0];
            R(u) || (s = c["msgImage" + r + i], o = "Width" === r ? f.naturalWidth || f.width : f.naturalHeight || f.height, d = "Small" === i ? o >= u : u >= o, t.length && !d && (s = s.replace("{name}", n).replace("{size}", u), c.showUploadError(s, l), c.setThumbStatus(a, "Error"), c.filestack[e] = null))
        },
        ...
        setCaption: function(i, t) {
            var a, n, r = this;
            if (t) a = e("<div>" + r.msgValidationError + "</div>").text(), n = '<span class="' + r.msgValidationErrorClass + '">' + r.msgValidationErrorIcon + a + "</span>";
            else {
        ...
        fileSingle: "archivo",
        filePlural: "archivos",
        browseLabel: "Explorar &hellip;",
        removeLabel: "Borrar",
        removeTitle: "Eliminar archivos seleccionados",
        cancelLabel: "Cancelar",
        cancelTitle: "Abortar subida",
        uploadLabel: "Enviar",
        uploadTitle: "Enviar archivos seleccionados",
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el límite máximo de <b>{maxSize} KB</b>.',
        msgFilesTooLess: "Debes seleccionar al menos <b>{n}</b> {files} para enviar.",
        msgFilesTooMany: "El número de archivos seleccionados <b>({n})</b> excede el límite máximo permitido de <b>{m}</b>.",
        msgFileNotFound: '¡Archivo "{name}" no encontrado!',
        msgFileSecured: 'Restricciones de seguridad impideron leer el archivo "{name}".',
        msgFileNotReadable: 'Archivo "{name}" no se pudo leer.',
        msgFilePreviewAborted: 'Vista previa abortada para "{name}".',
        msgFilePreviewError: 'Un error ocurrió durante la lectura del archivo "{name}".',
        msgInvalidFileType: 'Tipo inválido de archivo "{name}". Solo se soportan formatos "{types}".',
        msgInvalidFileExtension: 'Extensión inválida de archivo "{name}". Solo se soportan extensiones "{extensions}".',
        msgValidationError: "Error de envío",
        msgLoading: "Enviando archivo {index} de {files} &hellip;",
        msgProgress: "Enviando archivo {index} de {files} - {name} - {percent}% completado.",
        msgSelected: "{n} {files} seleccionados",
        msgFoldersNotAllowed: "¡Arrastra solo imágenes! Las carpetas fueron omitidas.",
        msgImageWidthSmall: 'Anchura de la imagen "{name}" debe ser al menos {size} px.',
        msgImageHeightSmall: 'Altura de la imagen "{name}" debe ser al menos {size} px.',
        msgImageWidthLarge: 'Anchura de la imagen "{name}" no puede exceder {size} px.',
        msgImageHeightLarge: 'Altura de la imagen "{name}" no puede exceder {size} px.',
        dropZoneTitle: "Arrastra las imágenes aquí &hellip;"
